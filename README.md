...
Для работы с базой PostgreSQL запустить приложение командой 'java -jar ./artifacts/aqa-shop.jar -spring.datasource.url=jdbc:postgresql://localhost:5432/app'.
3. Запустить автотесты командой './gradlew clean test' . 
Для работы с базой PostgreSQL запустить автотесты командой './gradlew clean test -Ddb.url=jdbc:postgresql://localhost:5432/app'.
